...
// ------ Functions ------
// This custom function works somewhat like a serial.print - You can send it an array of chars (string) and it'll print - the first 4 characters in the array - change Address of target hardware

void s7sSendStringI2C(String toSend, byte Address) {
...
void s7sStartSequence (byte Address) // Starting sequence
{
...
// Send the clear display command (0x76) - This will clear the display and reset the cursor - change Address of target hardware
